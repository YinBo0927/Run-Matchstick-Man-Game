...
#define back_mid ":/new/prefix1/image/background3.png"
#define back_down ":/new/prefix1/image/foggy.png"
#define before ":/new/prefix1/image/background5.png"
#define ground_img ":/new/prefix1/image/ground.png"
#define hurtimg ":/new/prefix1/image/hurt.png"
#define gameover ":/new/prefix1/image/over1.jpg"
#define pause ":/new/prefix1/image/pause.png"
//#define jump ":/new/prefix1/sound/jump.wav"
//#define coin ":/new/prefix1/sound/coin.wav" //音频过多容易造成游戏界面卡顿，因此舍弃原计划的这两个音频
...
void gamewidget::paintEvent(QPaintEvent *event)
{
    ...
    else if(GameOver==true)  //结束游戏界面显示
    {
        //GameIsOver绘制
        ...
        if(GameOver)
        {
            painter.drawPixmap(QRect(0,0,1280,720),gameOverImg);
        }
    }
    else  //游戏中绘制
    {
...
void gamewidget::addObstacle()   //添加障碍物
{
